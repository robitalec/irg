...
More details in the first vignette: [Getting started with IRG](https://github.com/robitalec/irg/articles/getting-started-with-irg.html). 
...
Here, we use the meta function `irg`. Alternatively, use the filtering, scaling, modeling and IRG functions separately (see [Getting started with IRG](https://robitalec.github.io/irg/articles/getting-started-with-irg.html)). 
